...
new_return = """  return (
    <View style={styles.container}>
      ...
      <LinearGradient colors={['#FFD2A8', '#FFB786', '#FFA46A']} style={StyleSheet.absoluteFill} />
...
new_styles = """
  ...
  wordNew: { fontSize: 28, fontWeight: '600', color: '#2A2A2A', textAlign: 'center', lineHeight: 40 },
