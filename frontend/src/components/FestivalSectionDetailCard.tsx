...
const FestivalSectionDetailCard = ({ festival, section }: FestivalSectionDetailCardProps) => {
  ...
  if (section === 'Story') {
    ...
    const heroImageSource = isHariyaliTeej
      ? require('../../assets/images/festivals/hariyali_teej_story_hero.png')
      : isKajariTeej
      ? require('../../assets/images/festivals/kajari_teej_story_hero.png')
      : isNagPanchami
      ? require('../../assets/images/festivals/nag_panchami_story_hero.png')
      : isOnam
      ? require('../../assets/images/festivals/onam_story_hero.png')
      : isRakshaBandhan
      ? require('../../assets/images/festivals/raksha_bandhan_story_hero.png')
      : isJanmashtami
      ? require('../../assets/images/festivals/janmashtami_story_hero.png')
      : isGaneshChaturthi
      ? require('../../assets/images/festivals/ganesh_chaturthi_story_hero.png')
      : isNavratri
      ? require('../../assets/images/festivals/navratri_story_hero.png')
      : isDiwali
      ? require('../../assets/images/festivals/diwali_story_hero.png')
      : isShivratri
      ? require('../../assets/images/festivals/maha_shivratri_story_hero.png')
      : festivalImg;

    const chapter1ImageSource = isHariyaliTeej
      ? require('../../assets/images/festivals/parvati_longing_chapter1.png')
      : isKajariTeej
      ? require('../../assets/images/festivals/kajari_teej_story_hero.png')
      : isNagPanchami
      ? require('../../assets/images/festivals/nag_panchami_chapter1.png')
      : heroImageSource;
