...
const MANTRA_DATA: Record<string, { text: string; bg: any }> = {
  gayatri: {
    ...
    bg: { uri: 'https://brahmandfeed23.b-cdn.net/assets/jaap_hero_shiva_final.webp' },
  },
  hanuman: {
    ...
    bg: { uri: 'https://brahmandfeed23.b-cdn.net/assets/hanuman_jaap_card_v2.webp' },
  },
  krishna: {
    ...
    bg: { uri: 'https://brahmandfeed23.b-cdn.net/assets/krishna_jaap_card_v2.webp' },
  },
  shiva: {
    text: 'ॐ\u00A0नमः\u00A0शिवाय',
    bg: { uri: 'https://brahmandfeed23.b-cdn.net/assets/jaap_hero_shiva_final.webp' },
  ...
  ganesh: {
    ...
    bg: { uri: 'https://brahmandfeed23.b-cdn.net/assets/ganesh_jaap_card.webp' },
  },
  laxmi: {
    text: 'ॐ श्रीं महालक्ष्म्यै नमः ॐ श्रीं महालक्ष्म्यै नमः ॐ श्रीं महालक्ष्म्यै नमः',
    bg: { uri: 'https://brahmandfeed23.b-cdn.net/assets/laxmi_jaap_card.webp' },
  },
  shani_chalisa: {
    ...
    bg: { uri: 'https://brahmandfeed23.b-cdn.net/assets/upcoming_shani.webp' },
  },
};
...
export default function LiveJaapRoomView() {
  ...
  return (
    <ImageBackground source={{ uri: 'https://brahmandfeed23.b-cdn.net/assets/live_jaap_room_bg.webp' }} style={styles.container} resizeMode="cover">
