...
// Message APIs
var sendCommunityMessage = function (communityId, subgroupType, content, messageType, category, mediaUrl, contact, sevaDetails, location) {
...
var deleteCommunityMessage = function (communityId, subgroupType, messageId) {
    return exports.api.delete("/messages/community/".concat(communityId, "/").concat(subgroupType, "/").concat(messageId));
};
