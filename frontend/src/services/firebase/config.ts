...
const anonymousPhoneList = getEnvVar('EXPO_PUBLIC_ANONYMOUS_PREDEFINED_NUMBERS', '');

export const firebaseConfig = {
  apiKey: getEnvVar('EXPO_PUBLIC_FIREBASE_API_KEY', 'AIzaSyBqj-JGtJNoRBE-5Brl0p_NALobh_PWPxE'),
