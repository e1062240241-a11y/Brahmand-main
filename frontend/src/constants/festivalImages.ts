...
const ganeshImg = require('../../assets/images/festivals/Ganesh Chaturthi.jpeg');
const durgaImg = require('../../assets/images/festivals/Sharad Navratri.jpg');
const shivaImg = require('../../assets/images/festivals/Maha Shivaratri.jpeg');
const gangaImg = require('../../assets/images/upcoming_ganga.jpg');
const radhaImg = require('../../assets/images/festivals/Janmashtami.jpg');
const hanumanImg = require('../../assets/images/festivals/Hanuman janmotsav.jpg');
