...
const upanishadsCover = { uri: 'https://brahmandfeed23.b-cdn.net/assets/featured_book_7.webp' };
const vedasCover = { uri: 'https://brahmandfeed23.b-cdn.net/assets/ancient_new_2.webp' };
const puranasCover = { uri: 'https://brahmandfeed23.b-cdn.net/assets/ancient_new_3.webp' };
const dharmaCover = { uri: 'https://brahmandfeed23.b-cdn.net/assets/ancient_new_4.webp' };
