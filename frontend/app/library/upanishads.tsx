...
const geeta3DImage = require('../../assets/images/tab-bar/books/upanishad.webp');
...
export default function UpanishadsPage() {
  ...
  const handleToggleBookmark = () => {
    const title = UPANISHAD_NAMES[currentChapter - 1] || `उपनिषद् ${currentChapter}`;
  ...
  const handleScroll = (event: any) => {
    ...
    updateProgress({
      id: BOOK_ID,
      chapterName: UPANISHAD_NAMES[currentChapter - 1] || `उपनिषद् ${currentChapter}`,
            ...
            <View style={{
              ...
              <View style={[styles.stickyTopHeader, { 
                ...
                <View style={styles.stickyChapterTitle}>
                  ...
                  <Text style={[styles.headerText, nightMode && styles.textNightLight]}>* {UPANISHAD_NAMES[currentChapter - 1]} *</Text>
                </View>
              ...
              <View style={styles.bottomNavContainer}>
                {currentChapter > 1 ? (
                  <TouchableOpacity style={[styles.bottomNavBtn, nightMode && styles.bottomNavBtnNight]} onPress={() => handleChapterChange(currentChapter - 1)}>
                    ...
                    <Text style={[styles.bottomNavText, nightMode && styles.textNight]}>पिछला उपनिषद्</Text>
                  </TouchableOpacity>
                ) : <View style={{ width: 100 }} />}
                
                {currentChapter < TOTAL_CHAPTERS ? (
                  <TouchableOpacity style={[styles.bottomNavBtn, nightMode && styles.bottomNavBtnNight]} onPress={() => handleChapterChange(currentChapter + 1)}>
                    <Text style={[styles.bottomNavText, nightMode && styles.textNight]}>अगला उपनिषद्</Text>
