...
const geeta3DImage = require('../../assets/images/atharva_veda.jpg');
// Custom bookmark icons


const BOOK_ID = 'atharvaved';
const TOTAL_CHAPTERS = 20;

export default function AtharvavedPage() {
  ...
  const handleToggleBookmark = () => {
    const title = `काण्ड ${currentChapter}`;
  ...
  const handleScroll = (event: any) => {
    ...
    updateProgress({
      id: BOOK_ID,
      chapterName: `काण्ड ${currentChapter}`,
  ...
  const fetchChapterData = async (chNum: number) => {
    setLoading(true);
    try {
      const response = await getAtharvavedChapter(chNum);
          ...
          <View style={[styles.root, { backgroundColor: nightMode ? '#1C1510' : '#FFF3EB' }]}>
            ...
            <View style={[styles.stickyTopHeader, { 
              ...
              <View style={styles.stickyChapterTitle}>
                ...
                <Text style={[styles.headerText, nightMode && styles.textNightLight]}>* काण्ड {convertToHindiNumerals(currentChapter)} *</Text>
              </View>
