...
const HELP_TYPES = ['Medical Support', 'Grocery Delivery', 'Mobility Help', 'Social Company', 'Other'];
const AGE_GROUPS = ['60-70', '70-80', '80+'];
const CONTACT_OPTIONS = ['Phone Call', 'WhatsApp', 'Platform DM'];

export default function SeniorCitizenRequestScreen() {
  ...
  const [modalType, setModalType] = useState<'help' | 'age' | 'contact' | null>(null);
  ...
  const openModal = (type: 'help' | 'age' | 'contact') => {
    setModalType(type);
  ...
  const handleSelectOption = (option: string) => {
    ...
    if (modalType === 'age') setAgeGroup(option);
  ...
  const handleContinue = async () => {
    ...
    if (!details.trim()) return Alert.alert('Error', 'Please provide details about the situation');
  ...
  const renderModalContent = () => {
    ...
    if (modalType === 'age') { options = AGE_GROUPS; title = 'Select Age Group'; }
            ...
            <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
              ...
              <View style={styles.headerBar}>
                ...
                <LinearGradient colors={['#E8EAF6', '#C5CAE9']} style={styles.iconCircle}>
                  <Ionicons name="people" size={28} color="#5C6BC0" />
                </LinearGradient>
              ...
              <View style={styles.fieldSection}>
                ...
                <View style={styles.searchInputContainer}>
                  <Ionicons name="location-sharp" size={18} color="#5C6BC0" style={{ marginRight: 10 }} />
                  <TextInput
                  ...
                  />
                  {isSearchingLocation ? <ActivityIndicator size="small" color="#5C6BC0" /> : <Ionicons name="search" size={18} color="#BBB" />}
                </View>
              ...
              <View style={styles.fieldSection}>
                <Text style={styles.fieldLabel}>Senior Citizen Details <Text style={styles.requiredAsterisk}>*</Text></Text>
