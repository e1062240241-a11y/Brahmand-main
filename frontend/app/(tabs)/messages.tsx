...
import { getCircles, getCommunities, createCommunityRequest, getCommunityRequests, getMyCommunityRequests, resolveCommunityRequest, parseApiError, getUserCulturalCommunity, getCulturalCommunities, updateUserCulturalCommunity } from '../../src/services/api';
    ...
    <SafeAreaView style={styles.container} edges={['bottom']}>
      ...
      <View style={styles.topTabsContainer}>
        ...
        {activeTopTab === 'Community' && (
          <View style={styles.lokSangmaCard}>
            <View style={styles.lokSangmaHeader}>
              <View>
                <Text style={styles.lokSangmaTitle}>Lok Sangam</Text>
                <Text style={styles.lokSangmaValue}>
                  {userLokSangma?.cultural_community || 'No Lok Sangam selected'}
                </Text>
              </View>
              <TouchableOpacity style={styles.lokSangmaButton} onPress={handleOpenLokSangmaModal}>
                <Text style={styles.lokSangmaButtonText}>{userLokSangma?.cultural_community ? 'Change' : 'Set'}</Text>
              </TouchableOpacity>
            </View>
          </View>
        )}
        ...
        <>
          ...
          {activeCommunityTab === 'Chat' ? (
            <>
              ...
              {userLokSangma?.cultural_community && (
                <View style={styles.lokSangamGroupBanner}>
                  <Text style={styles.lokSangamGroupText}>{`Lok Sangam group: ${userLokSangma.cultural_community}`}</Text>
                  <Text style={styles.lokSangamGroupSubtext}>Chat with your Lok Sangam members</Text>
                </View>
              )}
