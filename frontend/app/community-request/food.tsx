...
const HELP_TYPES = ['Cooked Food', 'Grocery Kit', 'Drinking Water', 'Other'];
...
export default function FoodRequestScreen() {
  ...
  const [modalType, setModalType] = useState<'help' | 'people' | 'contact' | null>(null);
  ...
  const openModal = (type: 'help' | 'people' | 'contact') => {
    setModalType(type);
  ...
  const handleContinue = async () => {
    ...
    try {
      ...
      Alert.alert('Success', 'Food request posted!', [{ text: 'OK', onPress: () => router.push('/(tabs)/profile') }]);
    } catch (error: any) {
    ...
    <View style={styles.mainContainer}>
      ...
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.topHeader}>
          <Text style={styles.topHeaderText}>Food / Grocery Help</Text>
        </View>
          ...
          <View style={styles.cardContainer}>
            <ScrollView contentContainerStyle={styles.content} showsVerticalScrollIndicator={false} keyboardShouldPersistTaps="handled">
              ...
              <View style={styles.headerBar}>
                ...
                <LinearGradient colors={['#FFF4EE', '#FFE8D9']} style={styles.iconCircle}>
                  <MaterialCommunityIcons name="basket" size={28} color="#F25C05" />
                </LinearGradient>
              ...
              <View style={styles.fieldSection}>
                ...
                <View style={styles.searchInputContainer}>
                  <Ionicons name="location-sharp" size={18} color="#F25C05" style={{ marginRight: 10 }} />
                  <TextInput
                  ...
                  />
                  {isSearchingLocation ? <ActivityIndicator size="small" color="#F25C05" /> : <Ionicons name="search" size={18} color="#BBB" />}
                </View>
              ...
              <View style={styles.fieldSection}>
                ...
                <View style={styles.textAreaWrapper}>
                  <TextInput
                    ...
                    placeholder="List of items (e.g. 5kg Rice, 2L Milk...)"
                    placeholderTextColor="#BBB"
                    value={itemsNeeded}
