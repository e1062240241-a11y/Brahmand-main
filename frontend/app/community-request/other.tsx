      ...
      <SafeAreaView style={styles.safeArea}>
        <View style={styles.topHeader}>
          ...
          <View style={styles.headerTitleContainer}>
            ...
            <Text style={styles.topHeaderSubtext}>General Support</Text>
          </View>
          <View style={styles.headerBadge}>
            <Ionicons name="ellipsis-horizontal-circle" size={14} color="#00796B" />
            <Text style={styles.headerBadgeText}>General</Text>
          </View>
        </View>
...
const styles = StyleSheet.create({
  ...
  headerBadgeText: { fontSize: 12, fontFamily: FONTS.bold, color: '#00796B', marginLeft: 4 },
  ...
  continueButton: { marginTop: 12, borderRadius: 28, overflow: 'hidden', shadowColor: '#00796B', shadowOffset: { width: 0, height: 6 }, shadowOpacity: 0.3, shadowRadius: 12, elevation: 5 },
  ...
  modalHeaderOrange: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 14, backgroundColor: '#00796B', paddingHorizontal: 16, paddingVertical: 12, borderRadius: 16 },
  ...
  optionItemSelected: { backgroundColor: '#E0F2F1', borderColor: '#B2DFDB' },
  optionText: { fontSize: 15, color: '#2C2C2E', fontFamily: FONTS.regular },
  optionTextSelected: { color: '#00796B', fontFamily: FONTS.bold },
});
