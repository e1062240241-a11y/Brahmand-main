...
import { View, Text, Image, StyleSheet, FlatList, TextInput, TouchableOpacity, Pressable, KeyboardAvoidingView, Platform, ActivityIndicator, Modal, Alert, Share, Animated, Keyboard, AppState, TouchableWithoutFeedback } from 'react-native';
...
ChatNativeVideoPlayer.displayName = 'ChatNativeVideoPlayer';
